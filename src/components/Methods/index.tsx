    ...
    <section className="articles">
      <article className='article one'>
        <div className="article-wrapper">
          <figure>
            <img src="https://ead.jungnapratica.com.br/wp-content/uploads/2017/11/psicologia-terapia-individual-1024x683.jpg" alt="" />
          </figure>
      ...
      <article className='article two'>
        ...
        <div className="article-wrapper">
          <figure>
            <img src="https://interhelpinternacao.com.br/blog/wp-content/webp-express/webp-images/uploads/2020/08/acompanhamento-terapeutico.jpg.webp" alt="" />
          </figure>
          <div className="article-body">
      ...
      <article className='article three'>
        ...
        <div className="article-wrapper">
          <figure>
            <img src="https://www.psicologoeterapia.com.br/wp-content/uploads/psicologos-para-terapia-de-casal-1024x682.jpg" alt="" />
          </figure>
          <div className="article-body">
      ...
      <article className='article four'>
        <div className="article-wrapper">
          <figure>
            <img src="https://blog.unicep.edu.br/wp-content/uploads/2022/03/curso-de-pedagogia-min-scaled.jpeg" alt="" />
          </figure>
          <div className="article-body">
      ...
      <article className='article five'>
        <div className="article-wrapper">
          <figure>
            <img src="https://cdn0.psicologia-online.com/es/posts/3/6/6/que_es_el_inconsciente_colectivo_segun_jung_5663_600.webp" alt="" />
          </figure>
          <div className="article-body">
      ...
      <article className='article six'>
        <div className="article-wrapper">
          <figure>
            <img src="https://www.telavita.com.br/blog/wp-content/uploads/2018/09/vicio.jpg" alt="" />
          </figure>
          <div className="article-body">
      ...
      <article className='article eight'>
        <div className="article-wrapper">
          <figure>
            <img src="https://www.portalseppmt.com.br/wp-content/uploads/2022/01/arvore-de-maos-comunidade-psicologia-comunitaria-portal-seppmt.jpg" alt="" />
          </figure>
          <div className="article-body">
      ...
      <article className='article nine'>
        <div className="article-wrapper">
          <figure>
            <img src="https://iptc.net.br/wp-content/uploads/2018/04/o-que-e-a-neuropsicologia-e-qual-sua-area-de-atuacao.jpg" alt="" />
          </figure>
          <div className="article-body">
      ...
      <article className='article ten'>
        <div className="article-wrapper">
          <figure>
            <img src="https://institutoneurosaber.com.br/wp-content/uploads/2018/02/crianca-por-meio-da-psicomotricidade-site-1.jpg" alt="" />
          </figure>
          <div className="article-body">
